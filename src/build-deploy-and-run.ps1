...
function Invoke-Test {
    ...
    if (-not $DockerAvailable) {
        ...
        dotnet test .\$solutionName -c $Configuration --no-build $DockerTestFilter
    }
    else { dotnet test .\$solutionName -c $Configuration --no-build }
